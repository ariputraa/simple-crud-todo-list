                    ...
                    <div class="card-body">
                        <form method="post" action="<?php echo e(route('tdl.update', ['tdl' => $tdl])); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="day" placeholder="Add DAY here ..." value="<?php echo e($tdl->day); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="goal" placeholder="Add GOAL here ..." value="<?php echo e($tdl->goal); ?>">
                            ...
                            <div class="mb-3">
                                ...
                                <input class="form-control" type="text" name="time" placeholder="Add TIME(Minutes) here ..." value="<?php echo e($tdl->time); ?>">
...
<?php /**PATH C:\Users\ari putra\sembilan\resources\views/Tdl/edit.blade.php ENDPATH**/ ?>